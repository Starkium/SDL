...
SDL_DYNAPI_PROC(bool,SDL_WebXR_IsAvailable,(void),(),return)
SDL_DYNAPI_PROC(bool,SDL_WebXR_IsSessionModeSupported,(SDL_WebXRSessionMode a),(a),return)
SDL_DYNAPI_PROC(SDL_WebXRSession*,SDL_WebXR_RequestSession,(SDL_WebXRSessionMode a,SDL_WebXRReferenceSpaceType b),(a,b),return)
SDL_DYNAPI_PROC(SDL_WebXRSessionState,SDL_WebXR_GetSessionState,(SDL_WebXRSession *a),(a),return)
SDL_DYNAPI_PROC(void,SDL_WebXR_EndSession,(SDL_WebXRSession *a),(a),)
SDL_DYNAPI_PROC(bool,SDL_WebXR_BindGPUDevice,(SDL_WebXRSession *a,SDL_GPUDevice *b),(a,b),return)
SDL_DYNAPI_PROC(bool,SDL_WebXR_BeginFrame,(SDL_WebXRSession *a,SDL_WebXRFrame *b),(a,b),return)
SDL_DYNAPI_PROC(void,SDL_WebXR_EndFrame,(SDL_WebXRSession *a),(a),)
SDL_DYNAPI_PROC(int,SDL_WebXR_GetViewCount,(SDL_WebXRSession *a),(a),return)
SDL_DYNAPI_PROC(bool,SDL_WebXR_GetRenderTargetSize,(SDL_WebXRSession *a,int *b,int *c),(a,b,c),return)
SDL_DYNAPI_PROC(bool,SDL_WebXR_GetHeadTransform,(SDL_WebXRSession *a,float *b),(a,b),return)
SDL_DYNAPI_PROC(unsigned int,SDL_WebXR_GetFramebuffer,(SDL_WebXRSession *a),(a),return)
SDL_DYNAPI_PROC(unsigned int,SDL_WebXR_GetColorTextureForView,(SDL_WebXRSession *a,int b),(a,b),return)
SDL_DYNAPI_PROC(unsigned int,SDL_WebXR_GetDepthTextureForView,(SDL_WebXRSession *a,int b),(a,b),return)
